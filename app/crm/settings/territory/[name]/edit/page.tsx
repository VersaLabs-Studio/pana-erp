// app/crm/settings/territory/[name]/edit/page.tsx
// Obsidian ERP v4.0 - Edit Territory Page
// @ts-nocheck
...
export default function EditTerritoryPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useFrappeDoc<Territory>("Territory", name);
  ...
  if (error || !territory) {
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-destructive">Territory not found</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={`Edit: ${territory.territory_name}`}
        subtitle={`ID: ${territory.name}`}
